...
#ifndef TACO_TOOLS_COMMON_COMPAT_MOSES_SYNTAX_TREE_H_
#define TACO_TOOLS_COMMON_COMPAT_MOSES_SYNTAX_TREE_H_
...
{
public:
  typedef std::vector<std::pair<std::string, std::string> > AttributeSeqType;
  AttributeSeqType m_attributes;
protected:
  int m_start, m_end;
  std::string m_label;
