#ifndef TACO_TOOLS_M1_LABEL_ST_SETS_EXTRACTOR_PARZU_H_
#define TACO_TOOLS_M1_LABEL_ST_SETS_EXTRACTOR_PARZU_H_
...
class ExtractorParZu : public Extractor {
 public:
  ExtractorParZu(const Options &options) : Extractor(options) {}
