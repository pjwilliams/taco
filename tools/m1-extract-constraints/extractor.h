#ifndef TACO_TOOLS_M1_EXTRACT_CONSTRAINTS_EXTRACTOR_H_
#define TACO_TOOLS_M1_EXTRACT_CONSTRAINTS_EXTRACTOR_H_
...
class Extractor {
 ...
 protected:
  ...
  FeaturePath infl_path_;
  FeaturePath case_path_;
  FeaturePath decl_path_;
};
