#ifndef TACO_SRC_TACO_BAD_FEATURE_STRUCTURE_SET_H_
#define TACO_SRC_TACO_BAD_FEATURE_STRUCTURE_SET_H_
...
class BadFeatureStructureSet {
 public:
  typedef boost::shared_ptr<const FeatureStructure> value_type;
  typedef DereferencingOrderer<value_type, BadFeatureStructureOrderer> Orderer;
